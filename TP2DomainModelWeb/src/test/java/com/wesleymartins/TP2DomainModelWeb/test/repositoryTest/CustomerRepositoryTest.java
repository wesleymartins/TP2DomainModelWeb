...
public class CustomerRepositoryTest {
    ...
    @Test
     ...
     public void readCustomer(){
         ...
         Assert.assertEquals(person.getfName(), "Scrappy");
    ...
    @Test(dependsOnMethods = "readCustomer")
     private void updateCustomer(){
         repo = ctx.getBean(CustomerRepository.class);
         Customer person = repo.findOne(id);
         Customer updatedCustomer = new Customer.Builder("Ameer").build();
        
         repo.save(updatedCustomer);
         
         Assert.assertEquals(updatedCustomer.getfName(), "Mallagie");
